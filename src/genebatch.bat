...
#Testing user-provided colors and dimensions
--bed "../testing/data/refFlat.txt.gz.1" -v "../testing/data/458_samples_from_bcm_bi_and_washu.annot.vcf.gz.1" -t "../testing/data/458_traits.csv" -g "T2D" --gene SAMD11 -p results/diffcolors --title "Different colors, dimensions" --nograph --png --color "#00ff00,#ff0000,#0000ff" --dimensions "12,8"
#Testing flanking amount and introns
--bed "../testing/data/refFlat.txt.gz.1" -v "../testing/data/458_samples_from_bcm_bi_and_washu.annot.vcf.gz.1" -t "../testing/data/458_traits.csv" -g "T2D" --gene SAMD11 -p results/flanking --title "Flanking & introns test" -f 200 --nograph --png --introns
