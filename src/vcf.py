...
class VCFdata:
	...
	def fetch_range(self, chrom, start, stop):
		...
		return [r for r in results if r.get_locus() >= start_locus and r.get_locus() <= stop_locus]
...
if __name__ == '__main__':
	filename = 'NA12878.HiSeq.WGS.bwa.cleaned.raw.subset.b37.vcf'
	filename = 'NA12878.HiSeq.WGS.bwa.cleaned.raw.subset.b37.vcf.gz'
	filename = '458_samples_from_bcm_bi_and_washu.annot.vcf.gz'
	filename = '458_samples_from_bcm_bi_and_washu.annot.vcf'
